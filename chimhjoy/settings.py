"""
Django settings for chimhjoy project.
...
SECRET_KEY = 'django-insecure-o6fmm8xj(&$ghyo_+0)&1i6ihyv2)of(!&w%s158$a!w9=@o#f'
...
WSGI_APPLICATION = 'chimhjoy.wsgi.application'
