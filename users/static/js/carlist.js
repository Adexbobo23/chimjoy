...
function displayBookingModal(carId) {
    ...
    if (pickupLocationInput && destinationInput && pickupDateInput && returnDateInput && nameInput) {
...
bookingForm.addEventListener("submit", function (event) {
  ...
  // if (carDetails) {
  //   const numberOfDays = calculateNumberOfDays(pickupDateInput, returnDateInput);
  //   // const totalPrice = numberOfDays * parseInt(carDetails.carPricePerDay);

  //   // Update the modal to display the number of days and the total price
  //   const numberOfDaysElement = document.getElementById("numberOfDays");
  //   // const totalAmountElement = document.getElementById("totalPricePerDay");
  ...
  //   //   totalAmountElement.textContent = `₦${totalPricePerDay.toFixed(2)}`;
  //   // }
  // }
});
